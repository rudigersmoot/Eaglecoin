...
static const int64 MAX_MONEY = 42048000 * COIN; // maximum of 42 004 800 coins
...
public:
    ...
    */
    ...
    {
        // Large (in bytes) low-priority (new, eaglecoin) transactions
        // need a fee.
        return dPriority > COIN * 1440 / 250; // 5760 blocks found a day. Priority cutoff is 1 UMW day / 250 bytes.
    }
